...
const DishCard = ({ dishData }) => {
    ...
    return (
        <>
            <div onClick={onOpen} className="my-2 relative w-full flex items-center bg-white border border-gray-400 rounded-lg shadow flex-row hover:bg-gray-100 cursor-pointer">
                ...
                <div className="flex flex-col justify-between p-4 leading-normal" style={{ all: 'unset' }}>
                    <h5 className="mb-2 pt-2 text-xl  font-bold tracking-tight text-gray-900">{dishData?.title}</h5>
                ...
                <ModalContent>
                    {(onClose) => (
                        <>
                            ...
                            <DishForm dish={dishData} onOpenChange={onOpenChange}/>
                            </ModalBody>
