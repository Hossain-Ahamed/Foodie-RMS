...
const OrderListForKitchenStuffTableRow = ({ order, PaymentType, refetch }) => {
        ...
        <>
            <tr>
                ...
                <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm text-center'>
                    ...
                    {
                        order?.status === "Processing" && <button onClick={handleApproveToCook} title="Preparing Food" className="inline-flex ml-3 cursor-pointer text-blue-500"><GiCampCookingPot size={25} /></button>
                    }


                    {
                        order?.status === "In The Kitchen" && <button onClick={handleApproveToDelivery} title="Ready to Serve" className="inline-flex ml-3 cursor-pointer text-gray-500"><CiDeliveryTruck size={25} /></button>
...
export default OrderListForKitchenStuffTableRow