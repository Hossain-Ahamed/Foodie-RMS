...
const DeliveryBoyDetailView = ({ order }) => {
    // console.log(order)
    return (
        ...
        <>
            ...
            <div className='p-3'>
                ...
                <div className="text-xs ">
                    <div className="grid grid-cols-4 border-black border-b border-dashed">
                    ...
                    <div className="">
                        {order &&
                            order?.Items && Array.isArray(order?.Items) && order?.Items.map(item => (
                                <div key={item?._id} className='grid grid-cols-4 py-1'>
                                    ...
                                    {/* <p className='text-gray-900 text-right'>৳ {item?.totalPrice.toFixed(1)}</p> */}
                ...
                <div className=" text-xs border-t border-black border-dashed">
                    ...
                    <div className="grid grid-cols-2  text-left py-1 font-semibold">
                        <span>Total</span>
                        <span className="text-right"> ৳ {order?.finalPrice.toFixed(1)}</span>
                    </div>
                </div>
            </div>
            <div className="px-2 md:px-5 rounded-md text-md grid gap-1 ">
                {/* timeline  */}
                <p className='my-2 text-lg font-semibold text-blue-700'>Timeline : </p>
...
export default DeliveryBoyDetailView;