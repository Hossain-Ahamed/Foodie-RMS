...
const PrintingSetup = () => {
  ...
  const { branch_name, res_name, res_img, res_id, branchID } =
    useRestauarantAndBranch();
        ...
        >
          <div>
            ...
            <input
              type="text"
              id="small-input"
              className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs appearance-none "
              {...register("headerText")}
              maxLength={40}
          ...
          <div className="flex flex-col">
            <Checkbox
              className="p-4"
              defaultSelected={data?.print_logo}
              onValueChange={(e) => {
                setValue("print_logo", e);
                setprintLogo(e);
              }}
            >
              Print Logo
            ...
            <Checkbox
              className="p-4"
              defaultSelected={data?.print_address}
              onValueChange={(e) => {
                setValue("print_address", e);
                setprint_address(e);
              }}
            >
              Print Address
            ...
            <Checkbox
              className="p-4"
              defaultSelected={data?.print_res_email}
              onValueChange={(e) => {
                setValue("print_res_email", e);
                setprint_res_email(e);
              }}
            >
              Print Email address
            </Checkbox>
            <Checkbox
              className="p-4"
              defaultSelected={data?.print_res_mobile}
              onValueChange={(e) => {
                setValue("print_res_mobile", e);
                setprint_res_mobile(e);
              }}
            >
              Print Mobile Number
            </Checkbox>
            ...
            <Checkbox
              className="p-4"
              defaultSelected={data?.print_kitchen_print}
              onValueChange={(e) => {
                setValue("print_kitchen_print", e);
                setprint_kitchen_print(e);
              }}
            >
              Print for Kitchen{" "}
            </Checkbox>
      ...
      <div className="w-full md:w-1/2  filter grayscale select-none cursor-move">
        <div className="w-80 h-fit min-h-[300px] bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 p-4">
          <div className="flex justify-center items-center flex-col">
            ...
            <p>
              {data?.res_name}{" "}
              <span className="text-xs">({data?.branch_name})</span>
            </p>
