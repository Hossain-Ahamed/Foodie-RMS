...
import { imageUpload, SwalErrorShow, validateSalesTax } from '../../../../assets/scripts/Utility'
                    ...
                    <div className=" h-full">
                        ...
                        <div className="flex flex-wrap pb-3 m-3 border-1 rounded">
                            ...
                            <div className="w-full  p-3">
                                ...
                                <input className="w-full px-4 py-2.5 text-base text-gray-900 font-normal outline-none focus:border-green-500 border border-gray-300 rounded-lg shadow-input" type="number" placeholder="700"
