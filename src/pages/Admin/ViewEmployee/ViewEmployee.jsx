                ...
                <div className="w-full md:w-3/4 p-3 mt-8">
                    <div className='p-6 h-full border border-coolGray-100 overflow-hidden bg-white rounded-md shadow-dashboard'>
                        <div className='flex flex-col md:flex-row justify-between items-center'>
                            ...
                            {
                                viewAsAdminOrNot ?
                                    <Link to={`/restaurant/${res_id}/branch/${branchID}/update-employee-profile/${data?._id}`} className="inline-flex items-center rounded-md bg-blue-50 px-4 cursor-pointer py-1 text-sm font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10">Edit</Link>
